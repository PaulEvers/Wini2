...
public class GameConstants {
    ...
    public static String[] WORLD_NAMES = {"Athena", "Bera", "Broa", "Windia", "Khaini", "Bellocan", "Mardia", "Kradia", "Yellonde", "Demethos", "Galicia", "El Nido", "Zenith", "Arcenia", "Kastia", "Judis", "Plana", "Kalluna", "Stius", "Croa", "Medere"};
...
//    private static final int[]  EXP_RATE_GAIN = {1, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2};    //fibonacci :3
